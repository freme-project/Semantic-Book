...
head -n 208 original/athens.html > ./out/introduction.html
...
head -n 31 original/athens.html > ./out/geography.html #head
head -n 775 original/athens.html | tail -n 361 >> ./out/geography.html
echo '</div></body></html>' >> ./out/geography.html
sed -i 's/<a [^>]*>//g' ./out/geography.html
sed -i 's/<\/a>//g' ./out/geography.html

#create administration.html; 804 --> 960 = 157
head -n 31 original/athens.html > ./out/administration.html #head
head -n 932 original/athens.html | tail -n 157 >> ./out/administration.html
echo '</div></body></html>' >> ./out/administration.html
sed -i 's/<a [^>]*>//g' ./out/administration.html
sed -i 's/<\/a>//g' ./out/administration.html

#create cityscape.html; 961 --> 1166 = 206
head -n 31 original/athens.html > ./out/cityscape.html #head
head -n 1138 original/athens.html | tail -n 206 >> ./out/cityscape.html
echo '</div></body></html>' >> ./out/cityscape.html
sed -i 's/<a [^>]*>//g' ./out/cityscape.html
sed -i 's/<\/a>//g' ./out/cityscape.html

#create economy.html; 1167 --> 1181 = 15
head -n 31 original/athens.html > ./out/economy.html #head
head -n 1153 original/athens.html | tail -n 14 >> ./out/economy.html
echo '</div></body></html>' >> ./out/economy.html
sed -i 's/<a [^>]*>//g' ./out/economy.html
sed -i 's/<\/a>//g' ./out/economy.html

#create demographics.html; 1182 --> 1302 = 121
head -n 31 original/athens.html > ./out/demographics.html #head
head -n 1274 original/athens.html | tail -n 120 >> ./out/demographics.html
...
head -n 31 original/athens.html > ./out/culture_and_contemporary_life.html #head
head -n 1509 original/athens.html | tail -n 234 >> ./out/culture_and_contemporary_life.html
...
head -n 31 original/athens.html > ./out/education.html #head
head -n 1545 original/athens.html | tail -n 36 >> ./out/education.html
echo '</div></body></html>' >> ./out/education.html
sed -i 's/<a [^>]*>//g' ./out/education.html
sed -i 's/<\/a>//g' ./out/education.html

#create environment.html; 1574 --> 1598 = 25
head -n 31 original/athens.html > ./out/environment.html #head
head -n 1570 original/athens.html | tail -n 25 >> ./out/environment.html
...
head -n 31 original/athens.html > ./out/olympic_games.html #head
head -n 1803 original/athens.html | tail -n 79 >> ./out/olympic_games.html
echo '</div></body></html>' >> ./out/olympic_games.html
sed -i 's/<a [^>]*>//g' ./out/olympic_games.html
sed -i 's/<\/a>//g' ./out/olympic_games.html

#create special_olympics.html; 1832 --> 1837 = 6
head -n 31 original/athens.html > ./out/special_olympics.html #head
head -n 1809 original/athens.html | tail -n 6 >> ./out/special_olympics.html
...
head -n 31 original/athens.html > ./out/international_relations.html #head
head -n 1840 original/athens.html | tail -n 31 >> ./out/international_relations.html
...
head -n 31 original/athens.html > ./out/other_locations_named_after_athens.html #head
head -n 1946 original/athens.html | tail -n 106 >> ./out/other_locations_named_after_athens.html
...
head -n 31 original/athens.html > ./out/see_also.html #head
head -n 1987 original/athens.html | tail -n 41 >> ./out/see_also.html
echo '</div></body></html>' >> ./out/see_also.html
sed -i 's/<a [^>]*>//g' ./out/see_also.html
sed -i 's/<\/a>//g' ./out/see_also.html

#create references.html; 2016 --> 2205 = 190
head -n 31 original/athens.html > ./out/references.html #head
head -n 2177 original/athens.html | tail -n 190 >> ./out/references.html
echo '</div></body></html>' >> ./out/references.html
sed -i 's/<a [^>]*>//g' ./out/references.html
sed -i 's/<\/a>//g' ./out/references.html

#create external_links.html; 2206 --> 5557 = 3352
head -n 31 original/athens.html > ./out/external_links.html #head
head -n 5529 original/athens.html | tail -n 3352 >> ./out/external_links.html
